...
| 变量               | 说明                                                         |
| ------------------ | ------------------------------------------------------------ |
| $args              | 变量中存放了请求URL中的请求参数。比如http://192.168.200.133/server?arg1=value1&args2=value2中的"arg1=value1&arg2=value2"，功能和query_string一样 |
...
server {
        ...
        listen  82;
        resolver 8.8.8.8;//设置DNS的IP，用来解析proxy_pass中的yv'ming
        location /{
